...
export default function RecordForm({
  ...
  return (
    <>
      <div
        className={`form-panel-backdrop${isOpen ? ' form-panel-backdrop--open' : ''}`}
        onClick={onClose}
      />
      <aside className={`form-panel${isOpen ? ' form-panel--open' : ''}`}>
        <div className="form-panel__header">
          Document Form
          <button type="button" className="form-panel__close" onClick={onClose} aria-label="Close">
            &#x2715;
          </button>
        </div>
      <form className="form-panel__body">
          ...
          <label>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                handleFieldChange('subjectText', recordForm.subjectText);
              }}
            />
          </label>
        </div>
        ...
        <div className="form-panel__actions">
          <button type="button" onClick={() => handleSaveRecord(onClose)} disabled={isSaving}>
